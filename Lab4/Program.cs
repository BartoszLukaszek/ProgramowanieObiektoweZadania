...
class App
{
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine();
        //Zadanie3
        //nie zroumiałem zadania, dla każdego new Cars() deklarowało mi domyślne wartości audi przez co wychodziło 4 takie same pojazdu a z treści zadania powinno wynikać 3
        //Zadanie4
